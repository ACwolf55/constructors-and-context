...
//const betterPass = new User('test',1,'learn@dev.com',[{id:154,title:'YO',rating:100}] )
...
User.prototype.addSavedPost = function (id,title,rating){
  ...
  User.prototype.removeSavedPost = function(id) {
     let x = this.savedPosts.findIndex(x => x === id);
      if(id === this.savedPosts.id){
        delete this.savedPosts[x]
      }
